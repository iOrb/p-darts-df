...
# OUT_DIR = 'out/acc/bi'
# FNs = ['pdarts','nt2_cutout','nt1']
# MSGs = ['pdarts','nt2_cutout','nt1']
# MODES = ['cif', 'cif','cif', 'cif']

# EXP_DIR = 'experiments/mult'
# OUT_DIR = 'out/acc/mult'
# FNs = ['40_nt2','40_pdarts','100_nt2','100_pdarts']
# MSGs = ['40_nt2','40_pdarts','100_nt2','100_pdarts']
# MODES = ['cif', 'cif','cif', 'cif']
